...
> 分数描述模型与具体任务交互时暴露出的能力充分度，不是模型静态能力或题目客观难度。被测模型未生成最终答案；本轨只评价最小结构化证据。
...
{'verification': 25, 'reasoning_planning': 10, 'instruction_role': 10}
...
| code_L5_005 | code_generation | 3 | 0.833 | 0.167 | verification |
| math_L1_006 | math_reasoning | 3 | 0.833 | 0.167 | verification |
| math_L2_007 | math_reasoning | 3 | 1.000 | 0.000 | reasoning_planning, instruction_role, verification |
| math_L3_008 | math_reasoning | 3 | 1.000 | 0.000 | reasoning_planning, instruction_role, verification |
| math_L4_009 | math_reasoning | 3 | 1.000 | 0.000 | reasoning_planning, instruction_role, verification |
...
| qa_L2_012 | knowledge_qa | 3 | 0.833 | 0.167 | verification |
| qa_L3_013 | knowledge_qa | 3 | 1.000 | 0.000 | reasoning_planning, instruction_role, verification |
...
| logic_L2_017 | logical_reasoning | 3 | 1.000 | 0.000 | reasoning_planning, instruction_role, verification |
| logic_L3_018 | logical_reasoning | 3 | 0.833 | 0.167 | verification |
| logic_L4_019 | logical_reasoning | 3 | 0.833 | 0.167 | verification |
| logic_L5_020 | logical_reasoning | 3 | 1.000 | 0.000 | reasoning_planning, instruction_role, verification |
